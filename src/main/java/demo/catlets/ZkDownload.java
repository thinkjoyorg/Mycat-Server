...
public class ZkDownload {
    ...
    private static String CONFIG_URL_KEY = "zkUrl";
...
//                            System.out.println("table:" + tableName);
                            ...
                            if (tableJsonObject.containsKey("type"))
                                if (tableJsonObject.get("type").toString().startsWith("1") || tableJsonObject.get("type").toString().startsWith("global")) //目前只有1 全局表
